...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xagg-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13074&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xagg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xagg` can be installed with:

```
conda install xagg
```

It is possible to list all of the versions of `xagg` available on your platform with:
